...
const CreateTask = () => {
  ...
  return (
    <div className='p-5 bg-[#1c1c1c] mt-7 rouded'>
    <form onSubmit={(e)=>{
        submitHandler(e);
    }} 
    ...
    >
        <div className='w-1/2'>
            <div>
                <h3 className='text-sm font-semibold text-gray-200 mb-0.5'>Task Title</h3>
                <input 
            ...
            <div>
                <h3 className='text-sm font-semibold text-gray-200 mb-0.5'>Date</h3>
                <input 
            ...
            <div>
                <h3 className='text-sm font-semibold text-gray-200 mb-0.5'>Assign To</h3>
                <input 
            ...
            <div>
                <h3 className='text-sm font-semibold text-gray-200 mb-0.5'>Category</h3>
                <input 
        ...
        <div className='w-2/5 flex flex-col items-start'>
            <h3 className='text-sm font-semibold text-gray-200 mb-0.5'>Descriptions</h3>
            <textarea
            ...
            <button className='bg-emerald-500 py-3 font-semibold  hover:bg-emerald-600 px-5 rounded text-m mt-4 w-full'>Create Task</button>
        </div>
